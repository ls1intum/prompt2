    ...
    <Card className="w-full">
      ...
      <CardFooter className="pt-2 pb-3">
        <div className="flex items-start gap-2 text-xs text-muted-foreground border-t pt-2 w-full">
          ...
          <p>
            This is just a rough indicator, not live data, and should only be used as guidance. Numbers may not reflect
            the current state and are updated periodically.
          </p>
        </div>
      </CardFooter>
    </Card>

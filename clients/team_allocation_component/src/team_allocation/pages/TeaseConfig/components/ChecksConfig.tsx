...
export const checksConfig: StudentCheck[] = [
  // Devices
  {
    ...
    problemDescription:
      'All students are missing information on which devices they have. Please check if your previous course phases ' +
  ...
  // Comments
  {
    ...
    problemDescription:
      'All students are missing comments from tutors. Please check if your previous course phases forward ' +
      'information on tutor comments to this phase.',
    details: 'Ensure tutors can provide comments on student performance.',
    category: 'comments',
    highLevelCategory: 'previous',
  ...
  },
  {
    ...
    problemDescription:
      'All students are missing comments from students. Please check if your previous course phases forward ' +
      'information on student comments to this phase.',
    details: 'Allow students to provide feedback or comments.',
    category: 'comments',
    highLevelCategory: 'previous',
    icon: <MessageSquare className='h-4 w-4' />,
  },
  ...
  // ScoreLevel
  {
    ...
    problemDescription:
      'All students are missing score levels. Please check if your previous course phases forward ' +
      'information on score levels to this phase.',
    details: 'Ensure score levels are assigned to students.',
    category: 'score',
    highLevelCategory: 'previous',
  ...
  // Language Proficiency
  {
    ...
    problemDescription:
      'All students are missing English proficiency levels. Please check if your previous course phases forward ' +
  ...
  },
  {
    ...
    problemDescription:
      'All students are missing German proficiency levels. Please check if your previous course phases forward ' +
  ...
  // Survey Results
  {
    ...
    problemDescription: 'All students are missing submitted the required survey.',
    details: 'Track whether students have submitted the required survey.',
    category: 'survey',

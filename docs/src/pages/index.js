    ...
    <Layout
      ...
      <div className="container margin-vert--lg">
        ...
        <section className={styles.section}>
          ...
          <div className={styles.featureGrid}>
            <div className={styles.featureCard}>
              ...
              <p>Build a course by assembling various course phases to suit your specific teaching needs.</p>
            </div>
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>
                <FileUser size={26} />
              ...
              <p>Streamline the application process for courses, making it easier for students to apply and for instructors to manage applications.</p>
            </div>
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>
                <UserCheck size={26} />
              ...
              <p>Efficiently manage student information and course participation.</p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.section} style={{ marginTop: '100px' }}>
          <Heading as="h2" className={styles.sectionTitle}>Dynamic Course Phases</Heading>
          <p className={styles.sectionDescription}>
            PROMPT allows instructors to create and manage independent course phases, 
          ...
          <div className={styles.featureGrid}>
            <div className={styles.featureCard}>
              ...
              <p>Manage and schedule interviews with applicants as part of the selection process.</p>
            </div>
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>
                <Upload size={26} />
              ...
              <p>Export data in a format compatible with TUM Matching for seamless integration.</p>
            </div>
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>
                <Users size={26} />
              ...
              <h2>Team Phase</h2>
              <p>Assign students to teams and projects, and manage project work throughout the course.</p>
            </div>
            <div className={styles.featureCard}>
              <div className={styles.featureIcon}>
                <Clipboard size={26} />
              ...
              <p>Conduct structured peer, self, and instructor assessments using a configurable framework.</p>
            </div>
            <div className={styles.featureCardCustomPhase}>
              ...
              <p>Easily extend PROMPT with custom phases tailored to your course needs.</p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.section} style={{ marginTop: '100px' }}>
          ...
          <div className={styles.featureGrid}>
            <div className={styles.linkCard}>
              ...
              <h3>Report a Bug</h3>
              <p>
                <a href="https://github.com/ls1intum/prompt2/issues" target="_blank" rel="noopener noreferrer">
                  Report an issue →
                </a>
              </p>
            </div>
            ...
            <div className={styles.linkCard}>
              ...
              <h3>Release Notes</h3>
              <p>
                <a href="https://github.com/ls1intum/prompt2/releases" target="_blank" rel="noopener noreferrer">
                  View releases →
                </a>
              </p>
            </div>

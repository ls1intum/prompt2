...
INSERT INTO course (id, name, start_date, end_date, semester_tag, course_type, ects, meta_data) VALUES ('64a12e61-a238-4cea-a36a-5eaf89d7a940', 'Another TEst', '2024-12-15', '2030-01-17', 'ios2425', 'seminar', 5, '{"icon": "folder", "bg-color": "bg-red-100", "some-secret-data": "secret"}');

...
SELECT
    weighted_scores.course_phase_id,
...
SELECT
    ...
    slc.score_level
FROM
    public.weighted_participant_scores slc
WHERE
    (
        EXISTS (
            SELECT
                1
            FROM
                public.assessment_completion ac
            WHERE
                (
                    (
...
--
ALTER TABLE
    ONLY public.assessment_completion
ADD
    CONSTRAINT assessment_completion_pkey PRIMARY KEY (course_participation_id, course_phase_id);

--
-- Name: assessment assessment_course_participation_id_course_phase_id_competen_key; Type: CONSTRAINT; Schema: public; Owner: -
--
ALTER TABLE
    ONLY public.assessment
ADD
    CONSTRAINT assessment_course_participation_id_course_phase_id_competen_key UNIQUE (
...
ALTER TABLE
    ONLY public.assessment
ADD
    CONSTRAINT assessment_competency_id_fkey FOREIGN KEY (competency_id) REFERENCES public.competency(id) ON DELETE CASCADE;

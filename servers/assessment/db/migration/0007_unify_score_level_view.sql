...
CREATE OR REPLACE VIEW weighted_participant_scores AS
...
SELECT
    ...
    CASE
        WHEN ROUND((weighted_score_sum / total_weight)::numeric, 2) < 1.75 THEN 'expert'
        WHEN ROUND((weighted_score_sum / total_weight)::numeric, 2) < 2.5 THEN 'advanced'
        WHEN ROUND((weighted_score_sum / total_weight)::numeric, 2) < 3.25 THEN 'intermediate'
        ELSE 'novice'
    END AS score_level
